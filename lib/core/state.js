 ...
 * @property {number} [autoOffAfterSeconds] - Time in seconds after which to run the offCommand.
 */

/**
 * @typedef {Object} ManualDeviceConfig
 * @property {string} name - The name of the manual device.
 * @property {string} [onCommand] - Shell command to run when the device is turned on.
 * @property {string} [offCommand] - Shell command to run when the device is turned off.
 * @property {number} [delayOnSeconds] - Delay in seconds before turning on.
 * @property {number} [delayOffSeconds] - Delay in seconds before turning off.
 */
...
/**
 * @typedef {Object} DiscoveredDeviceCustomization
 * @property {number} [delayOnSeconds] - Delay in seconds before turning on.
 * @property {number} [delayOffSeconds] - Delay in seconds before turning off.
 */
 ...
 * @property {string[]} [tpLinkKasaDevices] - List of TP-Link Kasa device IP addresses.
 * @property {ManualDeviceConfig[]} [manualDevices] - List of manual device configurations.
 ...
 * @property {Object.<string, DiscoveredDeviceCustomization>} [discoveredDeviceCustomizations] - Map of device name to customizations.
 */

/**
 * @typedef {Object} KasaDevice
 * @property {import('tplink-smarthome-api').Device} device - The Kasa device instance.
 * @property {string} host - The IP address of the device.
 * @property {string} name - The name of the device.
 * @property {string} state - The current state of the device ('on', 'off', or 'unknown').
 */

/**
 * @typedef {Object} AppState
 * @property {Object.<string, DiscoveredPDU>} discoveredPDUs - Map of host to discovered PDU.
 * @property {Object.<string, KasaDevice>} kasaDevices - Map of host to Kasa device.
 ...
 * @property {Set<string>} workingGroups - Set of group names currently being processed.
 * @property {Object.<string, 'on'|'off'>} manualDeviceStates - Map of manual device name to state.
 ...
 * @property {string[]} workingGroups - List of group names currently being processed.
 * @property {Object.<string, 'on'|'off'>} manualDeviceStates - Map of manual device name to state.
